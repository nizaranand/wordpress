...
Tags: code, editor, syntax, highlight, admin, ide, development, codemirror
License: GPLv2
...
* syntax highlight for a number of programming languages
...
Here is a list of features to expect in 4.x updates:
