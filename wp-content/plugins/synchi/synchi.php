...
function synchi_action_get_file_contents() {
    ...
    //if($extension != $clean_filename && !in_array($extension, $synchi_extensions)) synchi_ajax_error("File not supported!");
    if(!in_array($extension, $synchi_extensions)) synchi_ajax_error("File not supported!");
