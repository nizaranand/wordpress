...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-head">
		...
		<h2 class="post-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'fuzop' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>	
